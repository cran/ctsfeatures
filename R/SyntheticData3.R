#'
#' @title SyntheticData3
#' @description Synthetic dataset containing 80 MTS generated from four
...
#' NDARMA processes with different orders and vectors of coefficients.
