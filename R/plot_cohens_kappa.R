...
#'
#' \code{plot_cohens} constructs a serial dependence plot of a categorical
...
plot_cohens_kappa <- function(series, categories, max_lag = 10, alpha = 0.05, plot = TRUE,
  ...
  plot_cohens_kappa <- ggplot2::ggplot(data = df_plot_1, mapping = ggplot2::aes(x = x, y = y)) +
